...
public class EmployeesProjectTimesheetVerifyTotalHours extends WebBaseTest{
    ...
    @Test(groups = {"smoke"} )
    public void testEmployeesProjectTimesheetVerifyTotalHours() {
    	...
    	TestReporter.logStep("Verify total number of hours for that day is in 'Total' row");
    	TestReporter.assertTrue(rtSummary.verifyTotalHours(), "Verify total matches the correct value");
